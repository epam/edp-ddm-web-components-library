...
export default () => {
  return baseCheckboxForm([
    {
      key: 'display',
      components: ignoreBuilderFields(['inputType', 'customClass', 'autofocus', 'modalEdit']),
    },
    {
      key: 'data',
      components: ignoreBuilderFields(['persistent', 'protected', 'dbIndex', 'encrypted', 'calculateServer' ]),
    },
    {
      key: 'validation',
